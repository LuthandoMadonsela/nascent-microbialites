...
work_dir="/home/luthando/N1" #work_dir is where your input files are and where the output will go

assembly="/home/luthando/N1/N1_scaffolds.fasta" #assembly is the metagenome fasta file with a full path to where this file is located

ncbi="/home/luthando/Databases" #ncbi is the full path to where the NCBI databases are found. This does not include the file name.

marker_db="/home/luthando/Tools/Autometa/autometa/databases/markers" #marker spcifies were the marker files are. They should have been downloaded with autometa.

simpleName="N1" #A prefix for all output files specific to your sample

length_cutoff=1000 # in bp. Change this according to the N50 you got from running Quast.
