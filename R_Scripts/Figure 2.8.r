...
###Generating barplot of all OTUs from all samples (2019-2022), panel A
...
###Calculate pairwise ANOSIM scores, grouped by location (Table A6)
...
#Calculate pairwise ANOSIM scores, grouped by time (Table A6)
